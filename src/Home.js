        ...
        <div>
            ...
            <div className="posts">
                <div className="card-container">
                    ...
                    <Card className="card" img="none" date="May 23 2022" link="vscode-extensions" title="Mi Favorito VS Code Extensiones " description="Visual Studio Code is a very powerful code editor. Here are my favorite extensions I use to improve productivity."/>
                </div>
            </div>
